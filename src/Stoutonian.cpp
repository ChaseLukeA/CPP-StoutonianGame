...
void Stoutonian::speak()
{
    ...
    {
    case GameDesigner:
        cout << "  \"" << m_Name << " here, the best Game Designer in the universe!\"" << endl << randomAction() << endl;
        ...
        break;
    case MathGenius:
        cout << "  \"Cower before the great Math Genius " << m_Name << "!\"" << endl << randomAction() << endl;
        ...
        break;
    case InfoTechGuru:
        cout << "  \"I am " << m_Name << ", the IT Guru. No Stoutonian is better than me.\"" << endl << randomAction() << endl;
        cout << "  \"My " << m_InitialMentalSharpness << " Mental Sharpness gives me " << m_ChallengeStrength << " hit points.\"";
        break;
    default:
        cout << "  \"This is " << m_Name << ", nerd extraordinaire.\"" << endl << randomAction() << endl;
